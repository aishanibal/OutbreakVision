...
def generate_map_visualization():
    """
    Generate a map visualization of impact scores over time.
    Saves snapshots and a video of the visualization.
    Returns the paths to the video and snapshots.
    """
    # === Load World Map ===
    ...
    snapshot_folder = "static/ImpactScore_snapshots"
    ...
    return video_filename, snapshot_folder